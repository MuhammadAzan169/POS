...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        // Same mobile sizing contract as DialogContent: side gutters, rounded at
        // every width, and capped to the dynamic viewport so the confirm button
        // is always reachable.
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ref={ref}
    // The footer supplies the gap now, so the old mt-2 just doubled the spacing.
